package com.scan.booster.memory.lite.pro.view;
...
/**
 * Created by 15210 on 2018/1/17.
 */

public class HonorScreenadaptation {
    /**
     * 关联要监听的视图
     *
     * @param viewObserving
    ...
    public static void assistActivity(View viewObserving) {
        new HonorScreenadaptation(viewObserving);
    }
    ...
    private HonorScreenadaptation(View viewObserving) {
