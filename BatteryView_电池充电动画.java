...
import com.clean.to.fly.R;

/**
 * Created by 15210 on 2018/3/7.
 */
...
public class BatteryView extends SurfaceView implements SurfaceHolder.Callback,Runnable {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrArray != null) {
            ...
            backgroundColor = attrArray.getColor(R.styleable.BatteryLoadingView_backgroundColor,Color.parseColor("#162947"));
